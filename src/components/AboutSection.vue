...
// Ukuran ditentukan via CSS class — tidak ada dynamic inline style dari JS
const values = [
      ...
      <div class="grid lg:grid-cols-[1fr_380px] gap-16 lg:gap-24 items-start">
        ...
        <div>
          ...
          <div class="flex items-start gap-5 mb-10">
            ...
            <div class="pt-1">
              <h2 class="font-black text-[#dde8f5] leading-none tracking-tight mb-2"
        ...
        <!-- Right: values — pure CSS sizing, no JS string -->
        <div class="lg:pt-2">
          <p class="text-[10px] tracking-[.55em] uppercase font-mono text-[#2a4a5e] mb-10">Nilai Guild</p>
          ...
          <div class="divide-y divide-[#0d1e2e]">
            <div v-for="(val, i) in values" :key="val.label"
              ...
              <div>
                <!-- Ukuran via class — tidak ada inline font-size dari JS -->
                <h3 class="font-black uppercase leading-none text-[#c8d8ea] group-hover:text-white
                ...
                <p class="text-xs text-[#2a4a5e] group-hover:text-[#4a7a9b] transition-colors leading-relaxed">
                  {{ val.desc }}
                </p>
              </div>
              <span class="text-[10px] text-[#1a3050] font-mono flex-shrink-0">
                0{{ i + 1 }}
              </span>
            </div>
          </div>
